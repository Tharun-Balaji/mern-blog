			...
			<div className="max-w-2xl mx-auto p-3 text-center">
				<div>
					...
					<div className="text-md text-gray-500 flex flex-col gap-6">
						<p>
							Welcome to Tharun's Blog! This blog was created by
							Tharun Balaji as a personal project to share his
							thoughts and ideas with the world. Tharun is a
							passionate developer who loves to write about
							technology, coding, and everything in between.
						</p>

						<p>
							On this blog, you'll find weekly articles on topics such as web development,
							software engineering, and programming languages.
							Tharun is always learning and exploring new
